...
(function () {
    ...
    var mockApiUrl = 'https://67173fc2b910c6a6e02723a8.mockapi.io/api/contact';
    contactFormElement.addEventListener('submit', function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var name, email, contactNumber, subject, message, emailPattern, contactPattern, formData, response, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 6, , 7]);
                        return [4 /*yield*/, fetch(mockApiUrl, {
                                method: 'POST',
                                headers: {
